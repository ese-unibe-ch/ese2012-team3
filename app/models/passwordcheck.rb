...
# http://translateitbangkokpost.blogspot.ch/2010/06/nolls-top-3000-american-english-words.html
# (though there are only 2095 words in this list here...)
$PASSWORD_FORBIDDEN_WORDS = [  # all lowercase
    "about",
    "after",
    "again",
    "air",
